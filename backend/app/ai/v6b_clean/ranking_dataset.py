...
from app.ai.v6b_clean.feature_assembler import (
    FeatureAssembler,
)
from app.models.draw import Draw


class V6BCleanRankingDataset:
    """
    Predixa AI V6B-CLEAN Ranking Dataset.
    ...
    VERSION = "PREDIXA-V6B-CLEAN-RANKING-DATASET"
    ...
    def _validate_full_features(
        ...
        if (
            ...
            raise ValueError(
                "Unexpected V6B full feature count. "
                f"Expected "
    ...
    def build_from_draws(
        ...
        for target_index in range(
            ...
            if len(history) != window_size:
                raise ValueError(
                    "Invalid V6B feature-history size. "
        ...
        if dataset.empty:
            raise ValueError(
                "V6B-CLEAN ranking dataset is empty."
            )
        ...
        if dataset.isnull().any().any():
            ...
            raise ValueError(
                "V6B-CLEAN ranking dataset contains "
        ...
        if (
            ...
            raise ValueError(
                "Unexpected number of positive V6B labels. "
