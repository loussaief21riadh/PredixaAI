...
class V7RankingModel:
    """
    Predixa AI V7 - Global Candidate Ranking Model.
    ...
    def __init__(
        ...
        if (
            ...
            raise ValueError(
                "Unexpected V7 model feature count. "
    ...
    def build_prediction_dataset(
        ...
        if (
            ...
            raise ValueError(
                ...
                "feature count. "
                f"Expected "
                f"{V7RankingDataset.EXPECTED_FULL_FEATURE_COUNT}, "
